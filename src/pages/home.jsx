        ...
        <div className="flex flex-col items-center bg-main py-8 text-text">
            ...
            <div className="flex flex-col gap-6 text-black">
                ...
                <div className="flex gap-4">
                    ...
                    <div>
                        <h1 className="text-accent font-medium">Datastores</h1>
                        <p className="text-text text-sm max-w-[35ch]">Complex datastore design and implementation that is solid in production.</p>
                    </div>
                </div>
            </div>
        </div>
